...
with col1:
    st.image("images/ec_map.jpeg", caption="Map of my English Channel crossing in August 2025")
with col2:
    st.image("images/rthi.jpeg", caption="Me (yellow cap on the left) doing a long swim in Tomales Bay, CA in August 2024")
