...
INTRO_TEXT_2 = (
    ...
    "Now, I'm revisiting that database to do a deep dive on the data that my Garmin watch has been collecting over the years "
    "to give you an idea of what training for marathon swimming looks like. \n\n"
...
TRAINING_VOLUME_TEXT_2 = (
    ...
    "that was noted in the swarmplots in the previous section.\n"
